...
<body>
    ...
    <nav>
        <div class="logo">
            <a href="bcomism.php" style="font-size:40px;">BCOM ISM<em style="font-size: 30px;">  BACHELOR - INFORMATION SYSTEM MANAGEMENT</em></a>
        </div>
        <div class="menu-icon">
        <span></span>
      </div>
    ...
    <div id="video-container">
        ...
        <form action="validbcomism.php" method="POST">
             <center>
