...
<body>
    ...
    <nav>
        <div class="logo">
            <a href="bcomca.php" style="font-size:40px;">BCOM CA<em style="font-size: 30px;">  Bachelor of Commerce with Computer Applications</em></a>
        </div>
        <div class="menu-icon">
        <span></span>
      </div>
    ...
    <div id="video-container">
        ...
        <form action="validbcomca.php" method="POST">
             <center>
