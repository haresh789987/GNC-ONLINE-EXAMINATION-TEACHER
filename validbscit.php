...
<div style="display: flex; align-items: center;">
    ...
    <span style="margin-left: 10px; cursor: pointer;"><a href='bscit.php' style='color: black; text-decoration: none;'>  Click me to go home </a></span>
</div>
   
    <script>
        const myLordIcon = document.getElementById('myLordIcon');
        myLordIcon.addEventListener('click', function() {
            window.location.href = 'bscit.php';
        });
    </script>
<table class="table">
            ...
            <tr>
                ...
                <td>
                    <?php 
                        ...
                        $selCourse = $conn->query("SELECT * FROM course_tbl WHERE cou_id='$exmneCourse' AND cou_name='BSC IT' ")->fetch(PDO::FETCH_ASSOC);
