...
<div style="display: flex; align-items: center;">
    ...
    <span style="margin-left: 10px; cursor: pointer;"><a href='bsccs.php' style='color: black; text-decoration: none;'>  Click me to go home </a></span>
</div>
   
    <script>
        const myLordIcon = document.getElementById('myLordIcon');
        myLordIcon.addEventListener('click', function() {
            window.location.href = 'bsccs.php';
        });
    </script>
<table class="table">
  <thead class="thead-dark">
    ...
    $sec = $_POST['sec'];
    $coseid=$_POST['coseid'];
    $selExmne = $conn->query("SELECT * FROM examinee_tbl WHERE exmne_course='67' AND exmne_year_level='$yre' AND exmne_section='$sec' ORDER BY exmne_id DESC");
            ...
            <tr>
                ...
                <td>
                    <?php 
                        ...
                        $selCourse = $conn->query("SELECT * FROM course_tbl WHERE cou_id='$exmneCourse' AND cou_name='BSC CS' ")->fetch(PDO::FETCH_ASSOC);
