...
<body>
    ...
    <nav>
        <div class="logo">
            <a href="bca.php" style="font-size:40px;">BCA<em style="font-size: 30px;">  BACHELOR of COMPUTER APPLICATIONS</em></a>
        </div>
        <div class="menu-icon">
        <span></span>
      </div>
    ...
    <div id="video-container">
        ...
        <div class="video-content">
            <div class="inner">
              ...
              <p>PLEASE SELECT COURSE ID, EXAM AND DEPARTMENT</p>
        <form action="validbca.php" method="POST">
            <center>
