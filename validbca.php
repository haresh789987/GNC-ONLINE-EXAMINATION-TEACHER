...
<div style="display: flex; align-items: center;">
    ...
    <span style="margin-left: 10px; cursor: pointer;"><a href='bca.php' style='color: black; text-decoration: none;'>  Click me to go home </a></span>
</div>
   
    <script>
        const myLordIcon = document.getElementById('myLordIcon');
        myLordIcon.addEventListener('click', function() {
            window.location.href = 'bca.php';
        });
    </script>
<table class="table">
            ...
            <tr>
                ...
                <td>
                    <?php 
                        ...
                        $selCourse = $conn->query("SELECT * FROM course_tbl WHERE cou_id='$exmneCourse' AND cou_name='BCA' ")->fetch(PDO::FETCH_ASSOC);
