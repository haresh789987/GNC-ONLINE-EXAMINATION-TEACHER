...
<body>
    ...
    <nav>
        <div class="logo">
            <a href="bscda.php" style="font-size:40px;">BSC DA<em style="font-size: 30px;">Bachelor of Computer Science with Data Analytics  </em></a>
        </div>
        <div class="menu-icon">
        <span></span>
      </div>
    ...
    <div id="video-container">
        ...
        <form action="validbscda.php" method="POST">
            <center>
